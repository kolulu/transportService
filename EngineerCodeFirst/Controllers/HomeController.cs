...
namespace EngineerCodeFirst.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Statistic()
        {
            ...
            string query = "SELECT b.RegNum, CONCAT(d.DriverName, ' ', d.DriverSurname) AS Driver, CONCAT(l.LineNumber, ': ', l.Direction) AS Line FROM Buses b JOIN BusDriver bd ON b.BusID = bd.BusID JOIN Drivers d ON d.DriverID = bd.DriverID JOIN BusLine bl ON bl.BusID = b.BusID JOIN Lines l ON l.LineID = bl.LineID WHERE b.Status = 'ON' AND d.Status = 'ON';";
